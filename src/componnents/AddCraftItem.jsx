...
//         const data = { userName , subcategory_Name, item_name, customization,description,imageURL,price,rating ,processing_time,stockStatus,discount ,  userName ,userEmail}
...
//                     </label>
//                     <input name='userEmail' type="text" placeholder="User Email " className="input input-bordered input-secondary w-full  " />
//                     <br />
//                 </div>
